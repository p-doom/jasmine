...
from jasmine.models.tokenizer import TokenizerVQVAE
...
class Args:
    ...
    entity: str = ""
    project: str = ""
    name: str = "train_tokenizer_vqvae"
    tags: list[str] = field(default_factory=lambda: ["tokenizer", "vqvae"])
    log_interval: int = 50
